...
A lightweight and modern Note Taking App built with the MERN stack (MongoDB, Express, React, Node.js).
It supports full CRUD operations for managing notes, includes rate limiting via Upstash Redis, and is deployed on Render’s free tier.




🌐 Live Demo: https://simple-note-taking-app-mern.onrender.com
...
, and in production mode, it will serve the Vite frontend automatically.
...
Render will build and serve both frontend and backend automatically.
...
npm run start	Start backend and serve frontend (production mode)
...
👉 https://simple-note-taking-app-mern.onrender.com
